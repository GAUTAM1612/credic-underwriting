...
if uploaded_file:
    ...
    try:
        ...
        if not all(col in df.columns for col in required_cols):
            st.error("Uploaded file format not supported. Please upload proper bank statement.")
            st.stop()
        ...
        st.download_button("Download Excel Report",
                           open(temp_excel.name, "rb"),
                           file_name="Credic_Analysis.xlsx")
        ...
        st.download_button("Download CAM Report",
                           open(temp_pdf.name, "rb"),
                           file_name="Credic_CAM_Report.pdf")
